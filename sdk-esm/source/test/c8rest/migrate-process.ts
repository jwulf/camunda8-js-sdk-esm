...
import {
	type CamundaJobWorker,
	CamundaRestClient,
} from "../../c8-rest/index.js";
...
test("RestClient can migrate a process instance", async (t) => {
	...
	const response = await c8.deployResources({
		resources: loadResourcesFromFiles([
			"./distribution/test/resources/MigrateProcess-Rest-Version-2.bpmn",
		]),
	});
	...
	await c8.migrateProcessInstance({
		...
		targetProcessDefinitionKey:
			response.processDefinitions[0].processDefinitionKey,
	});
