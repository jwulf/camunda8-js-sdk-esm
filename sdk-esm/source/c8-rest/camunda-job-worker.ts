...
import type { LosslessDto } from "../c8-rest/lib/lossless-json.ts";
import type {
	ActivateJobsRequest,
	Ctor,
	Job,
...
import type { CamundaRestClient } from "./camunda-rest-client.ts";
...
> extends EventEmitter<CamundaJobWorkerEvents> {
	...
	private poll() {
		...
		const remainingJobCapacity = this.config.maxJobsToActivate -
