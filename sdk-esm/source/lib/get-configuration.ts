...
import type { Logger } from "./c8-logger.ts";
...
type EnforceArrayContent<T, K extends keyof any> = T extends K[] ? T : never;
...
export const isoSdkEnvironmentVariableDictionary = createCompleteKeysArray<
	IsoSdkEnvironmentVariable
>([
	"CAMUNDA_LOG_LEVEL",
	"ZEEBE_REST_ADDRESS",
	"CAMUNDA_OAUTH_DISABLED",
...
export type IsoSdkConfiguration =
	& ReturnType<
		typeof getEnv
	>
	& {
